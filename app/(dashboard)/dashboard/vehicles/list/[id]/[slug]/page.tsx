...
const DOC_TYPE_COLORS: Record<string, { bg: string; icon: string; badge: string }> = {
  ...
  last_valet_check_docs:    { bg: "bg-green-50",  icon: "text-green-600",   badge: "bg-green-100 text-green-700 border-green-200" },
  ...
  valet_check:              { bg: "bg-red-50",     icon: "text-red-600",     badge: "bg-red-100 text-red-700 border-red-200" },
