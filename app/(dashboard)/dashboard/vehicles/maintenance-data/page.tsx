...
//           {vehicles.map((vehicle) => (
//             <Card key={vehicle.id} className="border w-[320px] h-[420px] border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
...
//                 </div>
//                 </div>
//                 <CardDescription className="text-lg flex justify-between items-center text-gray-600 mb-1"><span className="text-black">Foster Hartley Van</span> {vehicle.vehicles_type?.name || "N/A"}<span></span></CardDescription>
// <div className=" flex justify-center items-center mb-2 ">
//  <div className=" w-[280px] h-[1px] bg-black   "></div>
  
//   </div>                <div className="space-y-1 text-sm text-gray-700">
