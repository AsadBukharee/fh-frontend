      ...
      <div className="min-h-screen bg-background p-8">
        <div className="mx-auto max-w-7xl space-y-8">
          <div className="space-y-3">
            <h1 className="text-4xl font-bold text-foreground tracking-tight">Fuel Checks History Management</h1>
            <p className="text-lg text-muted-foreground">Track and manage fuel logs history for fleet compliance</p>
          </div>
