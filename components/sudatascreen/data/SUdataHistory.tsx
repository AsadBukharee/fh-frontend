...
export default function SUHistoryScreen() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      console.log("API current_run_type:", apiData.data.current_run_type);
      console.log("Mapped activeTab:", runNameToId[apiData.data.current_run_type] || "early");
      ...
      apiData.data.runs.forEach((run) => {
        ...
        console.log(`Processing run: ${run.runName}, mapped to slotId: ${slotId}`);
      ...
      console.log("Updated transportData:", newTransportData);
    ...
    <div className="min-h-screen bg-white p-6">
      ...
      <div className="flex items-center mb-6 justify-between">
        <div className="items-center gap-4">
          <div className="flex items-center gap-4">
            <h1 className="text-2xl font-bold text-gray-900">Historical Transport Data</h1>
          </div>
          <div className="flex items-center gap-4">
      ...
      {!isLoading && (
        <div className="mb-4">
          ...
          {/* Filter Row */}
          <div className="flex items-center gap-4 mb-6 justify-evenly text-sm text-gray-600">
            {!isLoading && (
              <div className="flex items-center gap-4 justify-between">
                ...
                <div className="flex items-center gap-2">
                  <ExportButton data={filteredData} fileName="SU History Data Management" />
                  <Button
                    variant="outline"
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-gray-50 border-b">
                  ...
                  <TableHead className="text-center font-semibold bater" data-testid="total-header">Total</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
